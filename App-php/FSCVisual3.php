...
<table class ="table-hover" style="width:100%" id="table1">
  <tr>
  <th id="ip1t"> i<sub>pa</sub> </th> <th id="ip2t"> i<sub>pc</sub> </th> <th id="dipt">  Δi </th> <th id="divipt">i<sub>pa</sub>/i<sub>pc</sub>  </th> <th id="ep2t"> E<sub>pa</sub> </th> <th id="ep1t"> E<sub>pc</sub> </th> <th id="dept"> ΔE </th><th id="AUCt"> AUC <br> </th>
  </tr>
  <tr>
                ...
                <div class="box box1">
                  <div id="spark1">
                    ...
                    <table class ="table-hover center" style="width:80%">
                      <tr>
                      <th > p 5-HTi </th> <th> p 5-HTr </th> <th> p DA </th> <th> p HA</th> <th>p SP</th> <th> p pH </th>
                      </tr>
                      <tr>
                        <td id="p5ht"></td>
                        <td id="p5ht2"></td>
...
Area_array.push(trap_auc(arrayColumn(Iarray,i)));
};

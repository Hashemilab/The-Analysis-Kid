...
<img src="convimage.gif" alt="Illustration of 2D convolution" style="width:243px;height:243px; display:block;margin:auto;">
...
<img src="plotFFTExample.svg" alt="2D FFT Example plot" style="width:750px;height:500px; display:block;margin:auto;">
...
<h1 class="w3-large w3-text-indigo" ><b>1D Transient</b> &emsp; <a href="1D-transient.csv" type="csv" download="1D-transient.csv">
...
<h1 class="w3-large w3-text-indigo" ><b> i-V plot</b>  &emsp; <a href="iV-transient.csv" type="csv" download="iV-transient.csv">
<i class="fas fa-file-csv"></i></a></h1>
...
<p style="justify"> The export panel allows the user to download a csv file with the parametric analysis of the labelled cyclic voltammogram, as well as the class probabilities calculated by the neural network. As mentioned before, only DA release, 5-HT inhibition and release, HA release, pH peaks and certain switching peaks can currently be identified by the neural networks.   </p>
   ...
   <div class="CON" style="display: none;margin:30px 2%;">
     <h1 class="w3-xxxlarge w3-text-indigo" ><b>Kinetic Calibration</b> <a href="3D-colorplot.csv" type="csv" download="3D-colorplot.csv">
    <i class="fas fa-file-csv"></i></a> &emsp; <a href="3Dcolorplot.txt" type="txt" download="3Dcolorplot.txt"><i class="fa fa-file-text" aria-hidden="true"></i></a></h1>
     <hr style="width:800px;border:3px solid #3f51b5;" class="w3-round"; >
